...
public class DifferentialEvolution extends MultivariateMinimum {
     ...
     */
    private double F = 0.7 /* 0.5*/;

    /**
     * Crossing over factor (default 0.9)
     */
    private double CR = 0.9 /*1.0*/;
     ...
     */
    private DifferentialEvolution(int dim, int popSize) {
        ...
        for (int r0 = 0; r0 < populationSize; r0++) {
            ...
            for (int i = 0; i < dimension; i++) // perform binomial trials
            {
                ...
                if (rng.nextDouble() < CR || i == dimension - 1) {
                    ...
                    trialVector[n] = trialVector[n] + F * (x[n] - trialVector[n]) + F * (currentPopulation[r[1]][n] - currentPopulation[r[2]][n]);
            ...
            // Test this choice
            double trialCost = f.evaluate(trialVector);
