...
package game.trainers.gradient.Newton;
...
//                          "too many large steps, " +
    ...
    private static void bakslv_f77(int n, double a[][], double x[], double b[]) {
...
// SOLVE (L-TRANSPOSE)X=B. (BACK SOLVE)
    ...
    private static void chlhsn_f77(int n, double a[][], double epsm, double sx[], double udiag[]) {
...
// UNSCALE HESSIAN AND CHOLESKY DECOMPOSITION MATRIX
    ...
    private static void choldc_f77(int n, double a[][], double diagmx, double tol, double addmax[]) {
...
// FIND I,J ELEMENT OF LOWER TRIANGULAR MATRIX
    ...
    private static void dfault_f77(int n, double x[], double typsiz[], double fscale[], int method[], int iexp[], int msg[], int ndigit[], int itnlim[], int iagflg[], int iahflg[], double dlt[], double gradtl[], double stepmx[], double steptl[]) {
...
// SET FLAGS
    ...
    private static void dogdrv_f77(int n, double x[], double f[], double g[], double a[][], double p[], double xpls[], double fpls[], Uncmin_methods minclass, double sx[], double stepmx[], double steptl[], double dlt[], int iretcd[], boolean mxtake[], double sc[], double wrk1[], double wrk2[], double wrk3[]) {
...
// CHECK NEW POINT AND UPDATE TRUST REGION
    ...
    private static void dogstp_f77(int n, double g[], double a[][], double p[], double sx[], double rnwtln, double dlt[], boolean nwtake[], boolean fstdog[], double ssd[], double v[], double cln[], double eta[], double sc[], double stepmx[]) {
...
// WHICH HAS SCALED LENGTH DLT
    ...
    private static void forslv_f77(int n, double a[][], double x[], double b[]) {
...
// SOLVE LX=B. (FORWARD SOLVE)
    ...
    private static void fstocd_f77(int n, double x[], Uncmin_methods minclass, double sx[], double rnoise, double g[]) {
...
// UNIT VECTOR, AND EVALUATE I-TH  COMPONENT OF GRADIENT.
    ...
    private static void fstofd_f77(int n, double xpls[], Uncmin_methods minclass, double fpls[], double a[][], double sx[], double rnoise, double fhat[]) {
...
*/
    ...
    private static void fstofd_f77(int n, double xpls[], Uncmin_methods minclass, double fpls[], double g[], double sx[], double rnoise) {
...
// gradient
    ...
    private static void grdchk_f77(int n, double x[], Uncmin_methods minclass, double f[], double g[], double typsiz[], double sx[], double fscale[], double rnf, double analtl, double gest[]) {
...
// ANALYTIC GRADIENT.
        ...
        for (i = 1; i <= n; i++) {
            ...
            if (Math.abs(g[i] - gest[i]) > Math.max(Math.abs(g[i]), gs) * analtl) ker = 1;
        }
        if (ker == 0) return;
    ...
    private static void heschk_f77(int n, double x[], Uncmin_methods minclass, double f[], double g[], double a[][], double typsiz[], double sx[], double rnf, double analtl, int iagflg[], double udiag[], double wrk1[], double wrk2[]) {
...
// APPROXIMATION.
        ...
        for (j = 1; j <= n; j++) {
            ...
            if (Math.abs(a[j][j] - udiag[j]) > Math.max(Math.abs(udiag[j]), hs) * analtl) ker = 1;
            for (i = j + 1; i <= n; i++) {
                if (Math.abs(a[i][j] - a[j][i]) > Math.max(Math.abs(a[i][j]), hs) * analtl) ker = 1;
            }
        }
        if (ker == 0) return;
...
// CHECK NEW POINT AND UPDATE TRUST REGION
    ...
    private static void hookst_f77(int n, double g[], double a[][], double udiag[], double p[], double sx[], double rnwtln, double dlt[], double amu[], double dltp[], double phi[], double phip0[], boolean fstime[], double sc[], boolean nwtake[], double wrk0[], double epsm) {
...
// SC NOT ACCEPTABLE HOOKSTEP.  SELECT NEW AMU
    ...
    private static void hsnint_f77(int n, double a[][], double sx[], int method[]) {
...
*/
    ...
    private static void lltslv_f77(int n, double a[][], double x[], double b[]) {
...
// BACK SOLVE, RESULT IN X
    ...
    private static void lnsrch_f77(int n, double x[], double f[], double g[], double p[], double xpls[], double fpls[], Uncmin_methods minclass, boolean mxtake[], int iretcd[], double stepmx[], double steptl[], double sx[]) {
...
// CHECK IF NEW ITERATE SATISFACTORY.  GENERATE NEW LAMBDA IF NECESSARY.
        while (iretcd[1] >= 2) {
            ...
            if (Double.isNaN(fpls[1])) {
                iretcd[1] = 1;
                return;
            }
            // pavel kordik -> stop when I want
...
// BOTH CRITICAL POINTS POSITIVE, FIRST IS MINIMUM
    ...
    private static void mvmltl_f77(int n, double a[][], double x[], double y[]) {
/*
...
*/
    ...
    private static void mvmlts_f77(int n, double a[][], double x[], double y[]) {
/*
...
*/
    ...
    private static void mvmltu_f77(int n, double a[][], double x[], double y[]) {
/*
...
*/
    ...
    private static void optchk_f77(int n, double x[], double typsiz[], double sx[], double fscale[], double gradtl[], int itnlim[], int ndigit[], double epsm, double dlt[], int method[], int iexp[], int iagflg[], int iahflg[], double stepmx[], int msg[]) {
...
// (IF IAGFLG .EQ. 1) OR SNDOFD (OTHERWISE).
            ...
            if ((msg[1] / 8) % 2 == 0) Uncmin_f77.result_f77(n, x, f, g, a, p, itncnt, 1);
...
// PRINT RESULTS
    ...
    private static void optstp_f77(int n, double xpls[], double fpls[], double gpls[], double x[], int itncnt[], int icscmx[], int itrmcd[], double gradtl[], double steptl[], double sx[], double fscale[], int itnlim[], int iretcd[], boolean mxtake[], int msg[]) {
/*
...
// CHECK NUMBER OF CONSECUTIVE STEPS \ STEPMX
    ...
    private static void qraux1_f77(int n, double r[][], int i) {
...
*/
    ...
    private static void qraux2_f77(int n, double r[][], int i, double a, double b) {
...
*/
    ...
    private static void qrupdt_f77(int n, double a[][], double u[], double v[]) {
...
// TO UPPER TRIANGULAR (R*)
    ...
    private static void result_f77(int n, double x[], double f[], double g[], double a[][], double p[], int itncnt[], int iflg) {
...
// PRINT HESSIAN FROM ITERATION K
    ...
    private static void sclmul_f77(int n, double s, double v[], double z[]) {
...
*/
    ...
    private static void secfac_f77(int n, double x[], double g[], double a[][], double xpls[], double gpls[], double epsm, int itncnt[], double rnf, int iagflg[], boolean noupdt[], double s[], double y[], double u[], double w[]) {
...
// TRIANGULAR PART.
    ...
    private static void secunf_f77(int n, double x[], double g[], double a[][], double udiag[], double xpls[], double gpls[], double epsm, int itncnt[], double rnf, int iagflg[], boolean noupdt[], double s[], double y[], double t[]) {
...
// BFGS UPDATE
    ...
    private static void sndofd_f77(int n, double xpls[], Uncmin_methods minclass, double fpls[], double a[][], double sx[], double rnoise, double stepsz[], double anbr[]) {
...
// CALCULATE SUB-DIAGONAL ELEMENTS OF COLUMN
    ...
    private static void tregup_f77(int n, double x[], double f[], double g[], double a[][], Uncmin_methods minclass, double sc[], double sx[], boolean nwtake[], double stepmx[], double steptl[], double dlt[], int iretcd[], double xplsp[], double fplsp[], double xpls[], double fpls[], boolean mxtake[], int method, double udiag[]) {
