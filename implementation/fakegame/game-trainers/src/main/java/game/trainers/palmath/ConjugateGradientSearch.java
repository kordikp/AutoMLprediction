 ...
 * @version $Id: ConjugateGradientSearch.java,v 1.3 2007/05/01 15:25:31 kordikp Exp $
 */
public class ConjugateGradientSearch extends MultivariateMinimum {
     ...
     */
    private double defaultStep = 1.0;
     ...
     */
    private int conjugateGradientStyle = BEALE_SORENSON_HESTENES_STIEFEL_UPDATE;
    ...
    public ConjugateGradientSearch(int conGradStyle, int maxIterations) {
        this.conjugateGradientStyle = conGradStyle;
    ...
    public void optimize(MultivariateFunction f, double[] x, double tolfx, double tolx) {
        ...
        while (true) {
            ...
            if (stopCondition(fx, xvec, tolfx, tolx, false) || (maxFun > 0 && numFun > maxFun)) {
                break;
            }
            ...
            if (iteration >= maxIterations) {
                //System.out.println("Max iteration reached - ending optimization");
                break;
            }
            if (prin > 1) {
                System.out.println();
                System.out.println("Function value: " + f.evaluate(xvec));
                System.out.println();
