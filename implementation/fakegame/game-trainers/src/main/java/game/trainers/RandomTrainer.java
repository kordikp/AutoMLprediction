 ...
 * @version 1.1
 * <p>
 * <p>Title: Random - Trainer</p>
 * <p>Description: trainer class for RandomSearch</p>
 */
...
public class RandomTrainer extends Trainer implements Uncmin_methods {
    ...
    int cnt;
    private transient RandomSearch randomSearch;        // colony of ants used for computation
    ...
    public void setCoef(int coef) {
        super.setCoef(coef);
        randomSearch = new RandomSearch(this, coefficients, maxIterations,
                maxStagnation, min, max, gradientWeight,
                cycle, debugOn);
    }
