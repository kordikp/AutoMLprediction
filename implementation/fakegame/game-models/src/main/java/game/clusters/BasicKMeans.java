...
public class BasicKMeans {
    ...
    /**
     * Returns the seed used to seed the random number generator,
     * which is used for picking the initial cluster centers.
     *
     * @return
     */
...
//            System.out.println(mClusters.length + " clusters t: " + executionTime);
            ...
            // Clean up temporary game.data structures used during the algorithm.
            cleanup();
