...
/**
 * Allows to connect model into a hierarchical structure and to input data features
 */
public interface ModelConnectable extends Model {
    /**
     * Initialises embedded model
     *
     * @param modelConfig configuration of the model
     * @param inputs      vector of inputs
     * @param normalizer  - internal data normalizer (null if no normalization required)
     */
