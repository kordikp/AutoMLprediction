 ...
 */
public class SigmoidNormClassifierTest {
    ...
    public static void generateConfigurationOfModelsAndLoadData() {
        ...
        ConfigurationFactory.saveConfiguration(clc, "sigmoidnorm.cfg");
    ...
    public void buildClassifierFromXMLConfig() {
        ...
        CfgTemplate conf;
        conf = ConfigurationFactory.getConfiguration("sigmoidnorm.cfg");
